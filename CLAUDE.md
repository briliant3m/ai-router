...
FastAPI-сервер (Railway.app)
        ...
        │   • Категория (например. "Металлообработка")
        │   • Вид станка (например. "Токарный с ЧПУ")  ← свободный текст
        │   • Бюджет (например. "2 млн примерно")      ← свободный текст
        │   • Срок потребности (например. "2-3 месяца") ← свободный текст
        │   • Компания
        │   • Регион
        │
